...
class BME280:
    ...
    def refresh(self) -> bool:
        ...
        try:
            ...
            b1 = self.__bus.read_i2c_block_data(0x76, 0x88, 24)
            ...
            dig_H1 = self.__bus.read_byte_data(0x76, 0xA1)

            # BME280 address, 0x76(118)
            # Read data back from 0xE1(225), 7 bytes
            b1 = self.__bus.read_i2c_block_data(0x76, 0xE1, 7)
            ...
            self.__bus.write_byte_data(0x76, 0xF2, 0x01)
            # BME280 address, 0x76(118)
            # Select Control measurement register, 0xF4(244)
            #               0x27(39)        Pressure and Temperature Oversampling rate = 1
            #                                       Normal mode
            self.__bus.write_byte_data(0x76, 0xF4, 0x27)
            # BME280 address, 0x76(118)
            # Select Configuration register, 0xF5(245)
            #               0xA0(00)        Stand_by time = 1000 ms
            self.__bus.write_byte_data(0x76, 0xF5, 0xA0)
            ...
            data = self.__bus.read_i2c_block_data(0x76, 0xF7, 8)
